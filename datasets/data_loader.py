...
# from .MIMIC_CXR import ID_Categories, Categories_Description_chatgptShort
...
class TransVGDataset(data.Dataset):
    ...
    def __init__(self, args, data_root, split_root='data', dataset='ChestXray8',
        ...
        if self.dataset == 'MS_CXR':
            self.dataset_root = osp.join(self.root, self.data_root, 'ChestXray8')
        ...
        dataset_path = osp.join(self.root, self.split_root, self.dataset)
        ...
        for split in splits:
            ...
            imgset_path = osp.join(self.root, dataset_path, imgset_file)
            self.images += torch.load(imgset_path)

    def exists_dataset(self):
        return osp.exists(osp.join(self.root, self.split_root, self.dataset))
    ...
    def pull_item(self, idx):
        ...
        #     img_file = 'p12/p12423759/s53349935/b8c7a778-2f7f712d-5c598645-6aeebbb3-66ffbcc7.jpg'
