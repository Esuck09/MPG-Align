...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--output_dir', default='/mnt/DATASTORE/isaac/Code/Backup3/Backup/MedRPG-master/demo_cases',
    ...
    parser.add_argument('--eval_model', default='/mnt/DATASTORE/isaac/Code/Backup3/Backup/MedRPG-master/released_checkpoint/MedRPG.pth', type=str)
...
def calculate_iou(box1, box2):
    ...
    Parameters
    ----------
    box1 : list, tuple or np.array
        The (x1, y1, x2, y2) coordinates of the first box.
    box2 : list, tuple or np.array
        The (x1, y1, x2, y2) coordinates of the second box.

    Returns
    -------
    float
        in [0, 1]. The IoU of box1 and box2.
    """
...
def main(args):
    ...
    # case1
    # img_path = "/mnt/DATASTORE/isaac/Code/Backup3/Backup/MedRPG-master/data_demo/649af982-e3af4e3a-75013d30-cdc71514-a34738fd.jpg"
    # phrase = 'Small left apical pneumothorax'
    # bbox = [332, 28, 141, 48]  # xywh
    # # case2
    img_path = '/mnt/DATASTORE/isaac/Code/Backup3/Backup/MedRPG-master/ln_data/MS_CXR/files/p10/p10977201/s59062881/00363400-cee06fa7-8c2ca1f7-2678a170-b3a62a6e.jpg'
    phrase = 'small apical pneumothorax'
    bbox = [161, 134, 111, 37]

    # # case3 CAN USE THISSSSSS
    # img_path = '/mnt/DATASTORE/isaac/Code/Backup3/Backup/MedRPG-master/ln_data/MS_CXR/files/p18/p18426683/s59612243/95423e8e-45dff550-563d3eba-b8bc94be-a87f5a1d.jpg'
    # phrase = 'cardiac silhouette enlarged'
    # bbox = [196, 312, 371, 231]

    # # case4 CAN USE THISSSSSSSSS
    # img_path = '/mnt/DATASTORE/isaac/Code/Backup3/Backup/MedRPG-master/ln_data/MS_CXR/files/p10/p10048451/s53489305/4b7f7a4c-18c39245-53724c25-06878595-7e41bb94.jpg'
    # phrase = 'Focal opacity in the lingular lobe'
    # bbox = [467, 373, 131, 189]

    # # case5
    # img_path = '/mnt/DATASTORE/isaac/Code/Backup3/Backup/MedRPG-master/ln_data/MS_CXR/files/p19/p19757720/s59572378/13255e1f-91b7b172-02baaeee-340ec493-0e531681.jpg'
    # phrase = 'multisegmental right upper lobe consolidation is present'
    # bbox = [9, 86, 232, 278]
    # case6
    # img_path = '/mnt/DATASTORE/isaac/Code/Backup3/Backup/MedRPG-master/ln_data/MS_CXR/files/p10/p10469621/s56786891/04e10148-c36f7afb-d0aaf964-152d8a5d-a02ab550.jpg'
    # phrase = 'right middle lobe opacity, suspicious for pneumonia in the proper clinical setting'
    # bbox = [108, 405, 162, 83]
    # case7
    # img_path = '/mnt/DATASTORE/isaac/Code/Backup3/Backup/MedRPG-master/ln_data/MS_CXR/files/p10/p10670818/s50191454/1176839d-cf4f677f-d597a1ef-548bc32a-c05429f3.jpg'
    ...
    with torch.serialization.safe_globals([argparse.Namespace]):
        checkpoint = torch.load(args.eval_model, map_location='cpu', weights_only=True)
